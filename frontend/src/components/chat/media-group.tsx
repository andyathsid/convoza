...
interface MediaGroupProps {
  ...
  onOpenLightbox: (messages: MessageType[], index: number) => void;
}

const MAX_GROUP = 30;
const MAX_VISIBLE = 4;

function getAspect(msg: MessageType): "landscape" | "portrait" {
...
const MediaGroup = memo(({ messages, onOpenLightbox }: MediaGroupProps) => {
  ...
  const renderCell = (msg: MessageType, displayIndex: number) => {
