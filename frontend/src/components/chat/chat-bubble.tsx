...
export const StatusIndicator = ({ message, isCurrentUser, onRetry }: { message: MessageType; isCurrentUser?: boolean; onRetry?: (pendingId: string) => void }) => {
...
const SingleMedia = ({ message, onOpenMedia }: { message: MessageType; onOpenMedia?: (messageId: string, mediaIndex: number) => void }) => {
...
interface ChatBubbleProps {
  ...
  mediaGroup?: MessageType[] | null;
  onOpenGroupLightbox?: (messages: MessageType[], index: number) => void;
