...
import type { Chat, ChatListFilter, FirestoreMessage, CreateChatInput, SendMessageInput } from "@/features/chat/types/chat";
...
export interface ChatState {
  ...
  lastChatCursor: QueryDocumentSnapshot<DocumentData> | null;
